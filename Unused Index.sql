	...
	SELECT sh.name ,OBJECT_NAME(i.object_id) AS TableName, i.name AS [Unused Index]
	...
	INNER JOIN sys.schemas sh ON sh.schema_id = t.schema_id
	...
	--AND  sh.name = 'CRP'
	ORDER BY  sh.name ,OBJECT_NAME(i.object_id) ASC
